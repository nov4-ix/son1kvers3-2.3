...
export default function LoginPage() {
  ...
  const { signIn, signInWithGoogle, signInWithFacebook, signInWithTikTok } = useAuth();
  ...
  const handleSocialLogin = async (provider: () => Promise<void>) => {
    try {
      ...
      setError(error.message || 'Error al iniciar sesión con red social');
      setLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            ...
            <div>
              <button
                onClick={() => handleSocialLogin(signInWithTikTok)}
                disabled={loading}
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"
              >
                <span className="sr-only">Iniciar sesión con TikTok</span>
